...
typedef struct {
    union {
        struct {
            MGPIO_enuPins_t HSEVEN_SEG_PIN_A;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_B;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_C;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_D;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_E;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_F;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_G;
            MGPIO_enuPins_t HSEVEN_SEG_PIN_DP;
        };
        MGPIO_enuPins_t HSEVEN_SEG_PINS[HSEVEN_SEG_NUM_OF_SEVEN_SEG_PINS];
    };
